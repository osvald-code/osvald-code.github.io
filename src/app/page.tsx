...
{/* <div style={{ width: '100%', height: '600px', position: 'relative' }}> */}
  ...
  />
      ...
      <Card className="mx-auto sm:mx-auto my-10 sm:my-4 py-10 sm:py-2 sm:px-15 w-fit flex flex-col items-center lg:shadow-xl shadow-black/50 justify-center min-h-[100%] lg:min-h-[calc(90vh-4rem)] dark:bg-zinc-950/50">
