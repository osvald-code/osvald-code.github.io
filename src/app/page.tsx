...
>
    ...
    <div className="fixed inset-0 -z-10 w-full h-full pointer-events-none">
      ...
      <Card className="w-[90%] mx-auto sm:mx-auto my-35 sm:my-5 py-30 sm:py-2 sm:px-15 sm:w-fit sm:min-w-[80%] flex flex-col items-center lg:shadow-xl shadow-black/50 justify-center min-h-[100%] lg:min-h-[calc(90vh-4rem)] dark:bg-zinc-950/50">
